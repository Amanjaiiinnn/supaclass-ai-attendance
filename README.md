...
This project is built for learning and demonstration purposes. For production use, stronger authentication, better biometric safeguards, and privacy protections should be added.
